...
# Use --no-install-recommends to avoid problematic Java dependencies
...
# Initialize user-mode tlmgr tree and install comprehensive package set
...
RUN echo "# Full Layer: Haskell + TeX Combined" > ~/README-full.md && \
    ...
    echo "```bash" >> ~/README-full.md && \
    echo "tlmgr install package-name" >> ~/README-full.md && \
    echo "```" >> ~/README-full.md && \
    echo "" >> ~/README-full.md && \
