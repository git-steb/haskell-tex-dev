...
RUN set -a && . /tmp/versions.env && set +a && \
    echo "Loaded versions: VERSION=$VERSION, TEXLIVE_VERSION=$TEXLIVE_VERSION"
...
RUN echo "# Full Layer: Haskell + TeX Combined" > ~/README-full.md && \
    ...
    echo "- Haskell toolchain: see build_context/versions.env (GHC + optional wasm cross-compiler)" >> ~/README-full.md && \
    ...
    echo "```" >> ~/README-full.md && \
    echo "" >> ~/README-full.md && \
    echo "## CI and automation" >> ~/README-full.md && \
    echo "" >> ~/README-full.md && \
...
LABEL layer="full"
LABEL features="haskell,tex,ghc,wasm,cabal,stack,hls,luatex,unicode,ci-optimized"
